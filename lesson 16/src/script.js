...
const tick = () => {
  ...
  const ghost2Angel = -elapsedTime * 0.32;
  ghost2.position.x = Math.cos(ghost2Angel) * 5;
  ghost2.position.z = Math.cos(ghost2Angel) * 5;
  ghost2.position.y = Math.sin(elapsedTime * 4) + Math.sin(elapsedTime * 2.5);

  const ghost3Angel = -elapsedTime * 0.18;
  ghost3.position.x =
    Math.cos(ghost3Angel) * (7 + Math.sin(elapsedTime * 0.32));
  ghost3.position.z = Math.cos(ghost3Angel) * (7 + Math.sin(elapsedTime * 0.5));
